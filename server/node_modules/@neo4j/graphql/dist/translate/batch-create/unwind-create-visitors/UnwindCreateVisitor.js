...
class UnwindCreateVisitor {
    ...
    getAuthNodeClause(node, context, nodeRef) {
        if (node.auth) {
            ...
            if (authExpr) {
                return cypher_builder_1.default.concat(new cypher_builder_1.default.With("*"), cypher_builder_1.default.apoc.util.validate(cypher_builder_1.default.not(authExpr), constants_1.AUTH_FORBIDDEN_ERROR));
            }
        }
    }
        ...
        if (usedAuthFields.length) {
            return new cypher_builder_1.default.RawCypher((env) => {
                ...
                if (fieldsPredicates.length) {
                    ...
                    const fieldsAuth = cypher_builder_1.default.concat(new cypher_builder_1.default.With("*"), cypher_builder_1.default.apoc.util.validate(predicate, constants_1.AUTH_FORBIDDEN_ERROR)).getCypher(env);
