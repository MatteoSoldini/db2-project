...
export declare function createSubPredicate({ authRule, skipRoles, skipIsAuthenticated, allow, context, escapeQuotes, bind, where, }: {
...
//# sourceMappingURL=create-sub-predicate.d.ts.map