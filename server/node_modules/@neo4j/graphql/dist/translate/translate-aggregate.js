...
function translateAggregate({ node, context }) {
    ...
    if (allowAuth[0]) {
        cypherStrs.push(cypher_builder_1.default.apoc.util.validate(cypher_builder_1.default.not(new cypher_builder_1.default.RawCypher(allowAuth[0])), constants_1.AUTH_FORBIDDEN_ERROR, new cypher_builder_1.default.Literal([0])));
