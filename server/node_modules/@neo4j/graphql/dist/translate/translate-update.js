...
async function translateUpdate({ node, context, }) {
    ...
    if (nodeProjection?.fieldsByTypeName) {
        ...
        if (projection.meta?.authValidatePredicates?.length) {
            projAuth = cypher_builder_1.default.apoc.util.validate(cypher_builder_1.default.not(cypher_builder_1.default.and(...projection.meta.authValidatePredicates)), constants_1.AUTH_FORBIDDEN_ERROR, new cypher_builder_1.default.Literal([0]));
        }
    }
