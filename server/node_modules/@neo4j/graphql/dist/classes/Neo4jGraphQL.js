...
class Neo4jGraphQL {
    ...
    wrapFederationResolvers(resolvers) {
        ...
        // Merge generated and custom resolvers
        const mergedResolvers = (0, merge_1.mergeResolvers)([...(0, utils_1.asArray)(resolvers)]);
        return (0, resolvers_composition_1.composeResolvers)(mergedResolvers, resolversComposition);
    }
    ...
    async generateSubgraphSchema() {
        ...
        const { validateTypeDefs, validateResolvers } = this.parseStartupValidationConfig();
        if (validateTypeDefs) {
            (0, validation_1.validateDocument)(document, directives, types);
        }
        if (!this.schemaModel) {
            this.schemaModel = (0, generate_model_1.generateModel)(document);
        }
        ...
        const subgraphResolvers = (0, utils_2.getResolversFromSchema)(schema);
